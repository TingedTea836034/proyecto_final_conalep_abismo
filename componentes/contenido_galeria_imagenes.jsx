...
const IMAGES = [
    { id: "0001", src: "/img/suelo_fosa.jpeg", title: "Challenger Deep", depth: "11.034m", category: "PAISAJES", desc: "El punto más profundo conocido del planeta, fotografiado por primera vez en 1960." },
    { id: "0002", src: "/img/pez_linterna.jpeg", title: "Pez Linterna", depth: "1.000m", category: "CRIATURAS", desc: "Produce bioluminiscencia para atraer presas en la oscuridad total de la zona crepuscular." },
    { id: "0003", src: "/img/descenso.jpeg", title: "Descenso", depth: "4.000m", category: "EXPEDICIONES", desc: "Imagen captada durante el descenso de la expedición Vescovo en 2019." },
    { id: "0004", src: "/img/calamar_vampiro.jpeg", title: "Calamar Vampiro", depth: "3.000m", category: "CRIATURAS", desc: "Vampyroteuthis infernalis — ni calamar ni pulpo, una especie única que habita las profundidades." },
    { id: "0005", src: "/img/suelo_abisal.jpeg", title: "Sedimento Abisal", depth: "6.000m", category: "PAISAJES", desc: "El fondo marino cubierto de sedimento acumulado durante millones de años." },
    { id: "0006", src: "/img/submarino.jpeg", title: "Batiscafo", depth: "0m", category: "EXPEDICIONES", desc: "El Trieste, primer vehículo en alcanzar el fondo de la Fosa de las Marianas en 1960." },
    { id: "0007", src: "/img/pepino_de_mar.jpeg", title: "Pepino de Mar", depth: "8.000m", category: "CRIATURAS", desc: "Holoturia abisal, uno de los pocos organismos capaces de sobrevivir en la zona hadal." },
    { id: "0008", src: "/img/fosa.jpeg", title: "Fosa desde Arriba", depth: "0m", category: "PAISAJES", desc: "Vista satelital de la ubicación de la Fosa de las Marianas en el Océano Pacífico." },
];
...
// Lightbox corregido (onClose)
function Lightbox({ image, images, onNav, onClose }) {
    ...
    return (
        ...
        >
            ...
            >
                <div className="relative flex-1 min-h-[300px] w-full rounded overflow-hidden border border-blue-500/20">
                    {/* Cambio de <image> a <img> */}
                    <img
                        src={image.src}
                        alt={image.title}
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 inset-x-0 p-4 translate-y-2 group-hover:translate-y-0 transition-transform duration-400">
                ...
                <p className="text-blue-100/50 text-xs leading-relaxed mt-1 font-light max-h-0 overflow-hidden group-hover:max-h-16 transition-all duration-500 ease-out">
                    {image.desc}
                </p>
            </div>
...
export default function Galeria() {
    ...
    // Entrada sutil de toda la página
    useGSAP(() => {
        gsap.from(pageRef.current, { opacity: 0, duration: 1, ease: "power2.out" });
    });

    // Animación optimizada al filtrar (Corregida sin ScrollTrigger conflictivo)
    useGSAP(() => {
